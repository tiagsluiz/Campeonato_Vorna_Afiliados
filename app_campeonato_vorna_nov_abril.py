...
SEASON_START = pd.Timestamp("2026-11-01")
SEASON_END_EXCLUSIVE = pd.Timestamp("2027-05-01")
SEASON_MONTHS = ["2026-11", "2026-12", "2027-01", "2027-02", "2027-03", "2027-04"]
...
def main():
    ...
    st.caption("Período de teste: Novembro de 2026 a Abril de 2027 | Regras configuradas conforme regulamento")
    ...
    with st.expander("Resumo das regras aplicadas no cálculo"):
        st.markdown("""
        - Temporada considerada neste teste: **01/11/2026 a 30/04/2027**.
